...
public class ImGui {
    ...
    */
    ...
    public static boolean beginChild(final String strId, final ImVec2 size, final int imGuiChildFlags) {
        return nBeginChild(strId, size.x, size.y, imGuiChildFlags);
    }

    public static boolean beginChild(final String strId, final float sizeX, final float sizeY, final int imGuiChildFlags) {
        return nBeginChild(strId, sizeX, sizeY, imGuiChildFlags);
    }

    public static boolean beginChild(final String strId, final ImVec2 size, final int imGuiChildFlags, final int imGuiWindowFlags) {
        return nBeginChild(strId, size.x, size.y, imGuiChildFlags, imGuiWindowFlags);
    }

    public static boolean beginChild(final String strId, final float sizeX, final float sizeY, final int imGuiChildFlags, final int imGuiWindowFlags) {
        return nBeginChild(strId, sizeX, sizeY, imGuiChildFlags, imGuiWindowFlags);
    }

    public static boolean beginChild(final String strId, final int imGuiChildFlags, final int imGuiWindowFlags) {
        return nBeginChild(strId, imGuiChildFlags, imGuiWindowFlags);
    }
    ...
    */
    ...
    private static native boolean nBeginChild(String obj_strId, float sizeX, float sizeY, int imGuiChildFlags); /*MANUAL
        auto strId = obj_strId == NULL ? NULL : (char*)env->GetStringUTFChars(obj_strId, JNI_FALSE);
        ImVec2 size = ImVec2(sizeX, sizeY);
        auto _result = ImGui::BeginChild(strId, size, imGuiChildFlags);
        if (strId != NULL) env->ReleaseStringUTFChars(obj_strId, strId);
        return _result;
    */

    private static native boolean nBeginChild(String obj_strId, float sizeX, float sizeY, int imGuiChildFlags, int imGuiWindowFlags); /*MANUAL
        auto strId = obj_strId == NULL ? NULL : (char*)env->GetStringUTFChars(obj_strId, JNI_FALSE);
        ImVec2 size = ImVec2(sizeX, sizeY);
        auto _result = ImGui::BeginChild(strId, size, imGuiChildFlags, imGuiWindowFlags);
        if (strId != NULL) env->ReleaseStringUTFChars(obj_strId, strId);
        return _result;
    */

    private static native boolean nBeginChild(String obj_strId, int imGuiChildFlags, int imGuiWindowFlags); /*MANUAL
        auto strId = obj_strId == NULL ? NULL : (char*)env->GetStringUTFChars(obj_strId, JNI_FALSE);
        auto _result = ImGui::BeginChild(strId, ImVec2(0,0), imGuiChildFlags, imGuiWindowFlags);
        if (strId != NULL) env->ReleaseStringUTFChars(obj_strId, strId);
        return _result;
    */
    ...
    public static boolean beginChild(final int imGuiID, final ImVec2 size, final int imGuiChildFlags) {
        return nBeginChild(imGuiID, size.x, size.y, imGuiChildFlags);
    }

    public static boolean beginChild(final int imGuiID, final float sizeX, final float sizeY, final int imGuiChildFlags) {
        return nBeginChild(imGuiID, sizeX, sizeY, imGuiChildFlags);
    }

    public static boolean beginChild(final int imGuiID, final ImVec2 size, final int imGuiChildFlags, final int imGuiWindowFlags) {
        return nBeginChild(imGuiID, size.x, size.y, imGuiChildFlags, imGuiWindowFlags);
    }

    public static boolean beginChild(final int imGuiID, final float sizeX, final float sizeY, final int imGuiChildFlags, final int imGuiWindowFlags) {
        return nBeginChild(imGuiID, sizeX, sizeY, imGuiChildFlags, imGuiWindowFlags);
    }

    public static boolean beginChild(final int imGuiID, final int imGuiChildFlags, final int imGuiWindowFlags) {
        return nBeginChild(imGuiID, imGuiChildFlags, imGuiWindowFlags);
    }
    ...
    */
    ...
    private static native boolean nBeginChild(int imGuiID, float sizeX, float sizeY, int imGuiChildFlags); /*MANUAL
        ImVec2 size = ImVec2(sizeX, sizeY);
        auto _result = ImGui::BeginChild(imGuiID, size, imGuiChildFlags);
        return _result;
    */

    private static native boolean nBeginChild(int imGuiID, float sizeX, float sizeY, int imGuiChildFlags, int imGuiWindowFlags); /*MANUAL
        ImVec2 size = ImVec2(sizeX, sizeY);
        auto _result = ImGui::BeginChild(imGuiID, size, imGuiChildFlags, imGuiWindowFlags);
        return _result;
    */

    private static native boolean nBeginChild(int imGuiID, int imGuiChildFlags, int imGuiWindowFlags); /*
        return ImGui::BeginChild(imGuiID, ImVec2(0,0), imGuiChildFlags, imGuiWindowFlags);
    */
    ...
    */
     ...
     */
    public static boolean isKeyChordPressed(final int key) {
        return nIsKeyChordPressed(key);
    }

    private static native boolean nIsKeyChordPressed(int key); /*
        return ImGui::IsKeyChordPressed(static_cast<ImGuiKeyChord>(key));
    */
