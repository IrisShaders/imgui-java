...
public final class ImGuiStyle extends ImGuiStructDestroyable {
    ...
    */
     ...
     */
    public float getTabBarBorderSize() {
        return nGetTabBarBorderSize();
    }

    /**
     * Thickness of tab-bar separator, which takes on the tab active color to denote focus.
     */
    public void setTabBarBorderSize(final float value) {
        nSetTabBarBorderSize(value);
    }

    private native float nGetTabBarBorderSize(); /*
        return THIS->TabBarBorderSize;
    */
    ...
    */
     ...
     */
    public float getTableAngledHeadersAngle() {
        return nGetTableAngledHeadersAngle();
    }

    /**
     * Angle of angled headers (supported values range from -50.0f degrees to +50.0f degrees).
     */
    public void setTableAngledHeadersAngle(final float value) {
        nSetTableAngledHeadersAngle(value);
    }

    private native float nGetTableAngledHeadersAngle(); /*
        return THIS->TableAngledHeadersAngle;
    */

    private native void nSetTableAngledHeadersAngle(float value); /*
        THIS->TableAngledHeadersAngle = value;
    */
